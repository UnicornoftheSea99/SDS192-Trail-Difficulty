...
boundary_plot +
  ...
  geom_sf(data = trails[1, ], color = "red", size = 1.5) +
  geom_sf(data = trails[2, ], color = "orange", size = 1.5) +
  geom_sf(data = trails[3, ], color = "yellow", size = 1.5) +
  geom_sf(data = trails[4, ], color = "chartreuse", size = 1.5) +
  geom_sf(data = trails[5, ], color = "lightgreen", size = 1.5) +
  geom_sf(data = trails[6, ], color = "green", size = 1.5) +
  geom_sf(data = trails[7, ], color = "lightblue", size = 1.5) +
  geom_sf(data = trails[8, ], color = "blue", size = 1.5) +
  geom_sf(data = trails[9, ], color = "blueviolet", size = 1.5) +
  geom_sf(data = trails[10, ], color = "purple", size = 1.5) +
  geom_sf(data = trails[11, ], color = "violetred", size = 1.5) +
  geom_sf(data = trails[12, ], color = "magenta", size = 1.5) +
  geom_sf(data = trails[13, ], color = "pink", size = 1.5) +
  geom_sf(data = trails[14, ], color = "salmon", size = 1.5) +
  geom_sf(data = trails[15, ], color = "peachpuff", size = 1.5) +
  ...
  labs(
    title = "Trails at Macleish Station"
  )
```
