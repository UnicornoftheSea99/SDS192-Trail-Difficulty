...
bluePalette <- c("lightblue", "blue", "steelblue", "azure", "cadetblue", "cornsilk", "darkblue", "powderblue", "royalblue")

boundary_plot +
  geom_sf(data = elevations, color = "dark gray") +
  geom_sf(data = trails_full[1, ], color = "lightblue", size = 1.5) +
  geom_sf(data = trails_full[2, ], color = "blue", size = 1.5) +
  geom_sf(data = trails_full[3, ], color = "steelblue", size = 1.5) +
  geom_sf(data = trails_full[4, ], color = "azure", size = 1.5) +
  geom_sf(data = trails_full[5, ], color = "cadetblue", size = 1.5) +
  geom_sf(data = trails_full[6, ], color = "cornsilk", size = 1.5) +
  geom_sf(data = trails_full[7, ], color = "darkblue", size = 1.5) +
  geom_sf(data = trails_full[8, ], color = "powderblue", size = 1.5) +
  geom_sf(data = trails_full[9, ], color = "royalblue", size = 1.5) +
  ...
  scale_colour_manual(name="Trails",values = c("Snowmobile Trail" = "lightblue", "Eastern Loop" = "blue", "Western Loop" = "steelblue"))
